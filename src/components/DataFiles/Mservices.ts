...
const Mservice:Medical[] = [
    ...
    { id: 2, name: 'HIV/AIDS Management', description: "Our team in collaboration with Ampath (PPP) offers comprehensive treatment plans, including antiretroviral therapy, counseling services, and regular monitoring to manage your condition effectively and enhance your overall well-being." },
