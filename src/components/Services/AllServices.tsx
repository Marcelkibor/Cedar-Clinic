...
const AllServices = () => {
  ...
  const [servicePerPage, setServicePerPage] = useState(2);

  const services = [
    { id: 1, title: 'Radiology', description: 'New radiology services' },
    { id: 2, title: 'Histo', description: 'New radiology services' },
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', width: '100vw', height: '20vh', background: '#00b894', position: 'relative', top: '70px' }}>
        ...
        <h2 style={{ top: '25%', left: '12%', color: 'white', position: 'absolute' }}>All Services</h2>
      </div>
      <Row >
        <Col className='all-sv-row' style={{ width: '25vw' }}>
        ...
        <Col>
          <Row style = {{marginLeft:'-30%'}}>
            {displayServices.map(service => (
              <Col key={service.id} xs={6} style={{ marginBottom: '10px' }}>
